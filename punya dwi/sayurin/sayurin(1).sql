...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 08, 2018 at 08:41 PM
...
INSERT INTO `keranjang` (`id`, `user_id`, `sayur_id`, `jumlah`, `total_harga`, `created_at`, `updated_at`) VALUES
(5, 2, 1, 5, 20000, '2018-08-07 01:13:14', '2018-08-07 01:13:14'),
(6, 2, 2, 3, 9000, '2018-08-07 01:13:14', '2018-08-07 01:13:14');
...
(15, '2018_08_07_060953_create_transaksi_table', 3),
(16, '2018_05_12_031825_create_keranjang_table', 4);
...
CREATE TABLE `transaksi` (
  ...
  `total_harga` int(11) NOT NULL,
  `alamat` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status_transaksi` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
ALTER TABLE `transaksi`
  ...
  ADD KEY `transaksi_sayur_id_foreign` (`sayur_id`);
...
--
ALTER TABLE `transaksi`
  ADD CONSTRAINT `transaksi_sayur_id_foreign` FOREIGN KEY (`sayur_id`) REFERENCES `sayur` (`id`) ON DELETE CASCADE,
